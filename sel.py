...
class Scraping:
    ...
    def getTradePage(self):
        self.wait.until(
            EC.element_to_be_clickable(
                ...
                (By.XPATH, "/html/body/div[1]/div/div/div/main/div/div[2]/div/a[2]/span")
            )
        ).click()
    ...
    def preview(self):
        self.driver.find_element(
            By.XPATH, '//*[@id="app"]/div/main/div/div[3]/div[2]/div[1]/div[2]/form/div[3]/div/div[2]/button/span'
        ).click()
        

    def submit(self):
        time.sleep(2)
        self.driver.find_element(By.XPATH, "//*[@id='app']/div[3]/div/div/div[3]/div/div/div[2]/button/span").click()
...
test = Scraping()
test.executeOrder("AAPL", "Buy", 10, "Market",0)